...
Hlavným cieľom práce bolo porovnať rôzne tokeny. Ako výsledok tohto porovnania uvádzame tabuľku \ref{tab:vysledok}, ktorá je spojením tabuliek \ref{tab:porovnanie} a \ref{tab:api_porovnanie}. Podrobnejšia interpretácia uvedených hodnôt je v kapitolách \ref{kap:teoreticke} a \ref{kap:prakticke}.
