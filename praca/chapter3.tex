    ...
    \begin{center}
      ...
      \begin{tabular}{cccccc}
        ...
        PASETO & Python & dajiaji/pyseto \cite{paseto_python} & 34 & 601 & niekoľko dní \\
         ...
         & JavaScript & csquared/fernet.js \cite{fernet_js} & 66 & 52 & 3 roky \\
        Fernet & Python & pyca/cryptography \cite{fernet_python} & 5,5k & 10248 & dnes \\
...
Používanosť knižníc hodnotíme podľa počtu hviezd na platforme GitHub a urdžiavanosť podľa dátumu posledného commitu a celkového počtu commitov. Jednotlivé knižnice sú uvdené v tabuľke \ref{tab:implementacie}. Výsledky porovnania nájdeme v tabuľke \ref{tab:popularita}.
